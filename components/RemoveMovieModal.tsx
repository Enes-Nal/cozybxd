...
const RemoveMovieModal: React.FC<RemoveMovieModalProps> = ({ 
  movie, 
  onClose, 
  onConfirm,
  isPending = false 
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/90 backdrop-blur-xl p-4 animate-fade-in">
      <div className="glass w-full max-w-md rounded-[2.5rem] p-10 relative border-white/10 animate-scale-in">
        ...
        <div className="text-center py-4">
          ...
          <h2 className="text-2xl font-black mb-2">Remove from Queue?</h2>
          <p className="text-sm text-gray-400 mb-6">
            Are you sure you want to remove <span className="font-bold text-white">"{movie.title}"</span> from the group queue?
          </p>
