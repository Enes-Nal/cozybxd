        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button className="bg-[var(--accent-color)] text-black py-3 rounded-xl text-xs font-bold">Movies</button>
              ...
              {[5, 6, 7, 8, 9].map(r => (
                <button 
                  ...
                  className={`flex-1 py-2 rounded-lg text-xs font-bold transition-all border ${
                    ratingMin === r ? 'bg-[var(--accent-color)] border-[var(--accent-color)] text-black' : 'bg-white/5 border-white/5 text-gray-500'
                  }`}
                >
                  {r}+
                </button>
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-2">
              {['Action', 'Comedy', 'Sci-Fi', 'Romance', 'Horror', 'Drama', 'Thriller', 'Animation', 'Mystery'].map(g => (
                <button key={g} className="px-4 py-2 rounded-xl border border-white/5 bg-white/5 text-[10px] font-bold hover:border-[var(--accent-color)]/50 hover:text-white transition-all">
                  {g}
                </button>
              ))}
            </div>
          ...
          <section>
            ...
            <div className="space-y-2">
              <label className="flex items-center justify-between glass p-4 rounded-xl border-white/5 cursor-pointer hover:bg-white/10 transition-all">
                ...
                <input type="checkbox" className="w-4 h-4" style={{ accentColor: 'var(--accent-color)' }} defaultChecked />
              </label>
              ...
              <label className="flex items-center justify-between glass p-4 rounded-xl border-white/5 cursor-pointer hover:bg-white/10 transition-all">
                ...
                <input type="checkbox" className="w-4 h-4" style={{ accentColor: 'var(--accent-color)' }} />
              </label>
