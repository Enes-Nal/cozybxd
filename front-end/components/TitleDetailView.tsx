      ...
      <div className="relative min-h-[380px] w-full group overflow-hidden rounded-[2rem] mt-4 border border-main">
        ...
        <div className="relative h-full flex items-center px-10 py-10 max-w-6xl mx-auto z-10 gap-10">
          ...
          <div className="flex-1 flex flex-col justify-center animate-in slide-in-from-right duration-500">
            ...
            <p className="text-sm text-main/50 max-w-xl leading-relaxed mb-6 font-medium italic line-clamp-3">
              "A masterpiece of visionary storytelling. Exploring themes of destiny, power, and environmental legacy across the stars. This epic follow-up continues the journey of Paul Atreides as he unites with Chani and the Fremen while on a warpath of revenge against the conspirators who destroyed his family."
            </p>
